	...
	return (
		<div>
			...
			<p style={{ "border": "1px solid black", "backgroundColor": "pink" }}>
				In this example the translations for a specific language are downloaded on demand (in the default setup all translations
				for every supported languages are bundled).
				<br />
